...
public class CategoryDetailFragment extends Fragment {
    ...
    public ArrayList DB_read(String detail_category, Context context) {
        ...
        DatabaseReference delivery_Ref = category_Ref.child(detail_category);
        DatabaseReference delivery_apps_Ref = delivery_Ref.child("apps");

        if (detail_category.equals("transport")) {
            sub_String = (String) context.getText(R.string.sub_transport);
            System.out.println("여기" + sub_String);
        } else if (detail_category.equals("tour")) {
            sub_String = (String) context.getText(R.string.sub_tour);
            System.out.println("여기" + sub_String);
        } else if (detail_category.equals("realstate")) {
            sub_String = (String) context.getText(R.string.sub_realstate);
            System.out.println("여기" + sub_String);
        } else if (detail_category.equals("restaurant")) {
            sub_String = (String) context.getText(R.string.sub_restaurant);
            System.out.println("여기" + sub_String);
        } else if (detail_category.equals("delivery")) {
